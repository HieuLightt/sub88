...
$data = urldecode("username=$id&server_order=sv$server_buy&amount=$soluong&note=$ghichu");
...
$res = curl_send1("/api/service/tiktok/sub/order","https://thuycute.hoangvanlinh.vn/api/service/tiktok/sub/order",$data,$token);
$obj = json_decode($res);
