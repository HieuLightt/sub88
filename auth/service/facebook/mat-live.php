...
$data = urldecode("idpost=$id&server_order=sv$server_buy&amount=$soluong&minutes=$time_buy&note=$ghichu");
$token = $NTD->check('token_auto_dvfb');

$res = curl_send1("/api/service/facebook/eye-live/order","https://thuycute.hoangvanlinh.vn/api/service/facebook/eye-live/order",$data,$token);
$obj = json_decode($res);
