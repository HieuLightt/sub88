...
$data = urldecode("link_post=$id&server_order=sv$server_buy&reaction=$loai_camxuc&speed=$speed&amount=$soluong&note=$ghichu");
$token = $NTD->check('token_auto_dvfb');

$res = curl_send1("/api/service/facebook/like-post-sale/order","https://thuycute.hoangvanlinh.vn/api/service/facebook/like-post-sale/order",$data,$token);
$obj = json_decode($res);
        $result_text = $obj->status;
