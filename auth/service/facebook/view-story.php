...
$data = urldecode("link_story=$id&server_order=sv$server_buy&amount=$soluong&note=$ghichu");
$token = $NTD->check('token_auto_dvfb');

$res = curl_send1("/api/service/facebook/view-story/order","https://thuycute.hoangvanlinh.vn/api/service/facebook/view-story/order",$data,$token);
$obj = json_decode($res);
