...
$data = urldecode("link_post=$id&server_order=sv$server_buy&comment=$tinnhan&$amount=$soluong&note=$ghichu");
$token = $NTD->check('token_auto_dvfb');

$res = curl_send1("/api/service/facebook/$link_post/order","https://thuycute.hoangvanlinh.vn/api/service/facebook/$action/order",$data,$token);
$obj = json_decode($res);
