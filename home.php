...
<div class="lead">Số dư <b class="text-danger"><?=format_money($NTD->getUsers('money'));?></b> coin</div>
</div>
</div>
</div>
<div class="col-md-4 col-12">
...
<div class="lead">Đã nạp <b class="text-danger"><?=format_money($NTD->getUsers('tongnap'));?></b> coin</div>
</div>
</div>
</div>
<div class="col-md-4 col-12">
...
<div class="lead">Đã tiêu <b class="text-danger"><?=format_money($NTD->getUsers('tongtru'));?></b> coin</div>
</div>
</div>
</div>
</div>
...
<center>
<img src="/assets/images/svg/notification.svg" alt="" width="90">
</center>
