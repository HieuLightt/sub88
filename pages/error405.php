    ...
    <div style="display: table-cell; vertical-align: middle; padding: 0 40px;">
        <div style="margin-left: auto; margin-right: auto; width: 520px;">
            ...
            <div style="float:left; width:300px;">
                ...
                <span class="error_detail">The index file may not have been loaded, or the permissions for it may be incorrect.</span>
                <br>
                <input type="button" value="How to fix it ?" class="help_button" onclick="toggleHelp()">
            </div>
            <div style="clear:both"></div>
            <div id="fix_details">
             If you are a site administrator, the Error 403 Forbidden article in our help can help you fix this error .
            </div>
        </div>
    </div>
</div>
