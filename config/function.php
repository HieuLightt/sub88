...
{
    return base64_encode(urlencode(md5(urlencode(base64_encode(base64_encode(md5(md5(md5(md5(base64_encode(md5(base64_encode(md5(base64_encode(json_encode(array("user"=>base64_encode($string), "admin"=>"ThanhVũ", "kieumahoa"=>"ntiendat")))))))))))))))));
}
...
curl_setopt_array($curl, array(
      ...
      CURLOPT_HTTPHEADER => array(
       ...
       "path: $path",
        ...
        "origin: https://subvietnam.online",
