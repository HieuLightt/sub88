...
<a href="https://zalo.me/<?=$NTD->site('phone_zalo');?>" target="_blank" class="contact text-decoration-none"><span class="h6 font-bold text-100"><i class="fa fa-life-ring page_speed_960096975"></i> Liên Hệ & Hỗ Trợ </span></a>
</div>
<footer class="content-footer">
<div class="text-center">© 2022 <a href="#"><?=$NTD->site('ten_website');?></a> - Hệ thống được thiết kế và vận hành bởi <a href="#"><?=$NTD->site('full_name_admin');?></a>.</div>
</footer>
</div>
