...
define('USERNAME','sunmomos_phamquangnhat');
define('PASSWORD','sunmomos_phamquangnhat');
define('DATABASE','sunmomos_phamquangnhat');
...
class NTD
{
    ...
    function connect()
    {
        if (!$this->ketnoi)
        {
            $this->ketnoi = mysqli_connect(SERVERNAME,USERNAME,PASSWORD,DATABASE) or die ('Liên Hệ PQNIT.ASIA');
