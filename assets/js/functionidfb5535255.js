    ...
    function copy(id) {
        ...
        notifySuccess("Copy thÃ nh cÃ´ng " + copy.value);
    }
    ...
    function buyOrder() {
        Swal.fire({
            ...
            text: "Báº¡n Ä‘Ã£ Ä‘á»c háº¿t lÆ°u Ã½ vÃ  Ä‘Ã£ kiá»ƒm tra láº¡i Ä‘Æ¡n hÃ ng ?? ",
            icon: 'warning',
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data == 0) {
                    ...
                    $('input[name="' + name + '"]').attr('placeholder', "Lấy ID thất bại !");
                } else {
    ...
    function removeOrder(id, link) {
        Swal.fire({
            title: "Báº¡n Ä‘á»“ng há»§y id <span class='text-danger'>" + id + "</span>",
            html: "Sau khi báº¡n há»§y há»‡ thá»‘ng sáº½ hoÃ n láº¡i sá»‘ lÆ°á»£ng chÆ°a cháº¡y trong 24h vÃ  trá»« <span class='text-danger'>" + '5,000' + "</span> phÃ­ dá»‹ch vá»¥",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
    ...
    function warrantyOrder(id, link) {
        Swal.fire({
            title: "Báº¡n Ä‘á»“ng báº£o hÃ nh id <span class='text-danger'>" + id + "</span>",
            html: "Báº¡n Ä‘ang thá»±c hiá»‡n hÃ nh Ä‘á»™ng yÃªu cáº§u báº£o hÃ nh cho Ä‘Æ¡n hÃ ng " + id + " nÃ y . Ä‘Æ¡n hÃ ng sáº½ Ä‘Æ°á»£c xá»­ lÃ½ báº£o hÃ nh sau 1 > 3 ngÃ y . báº¡n cÃ³ muá»‘n tiáº¿p tá»¥c ?",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
    ...
    function checkOrder(id, link) {
        Swal.fire({
            title: "Báº¡n Ä‘á»“ng Ã½ kiá»ƒm tra Ä‘Æ¡n hÃ ng <span class='text-danger'>" + id + "</span>",
            html: "Báº¡n Ä‘ang yÃªu cáº§u thÃ´ng tin tráº¡ng thÃ¡i Ä‘Æ¡n hÃ ng " + id + " , báº¡n cÃ³ muá»‘n tiáº¿p tá»¥c ?",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
