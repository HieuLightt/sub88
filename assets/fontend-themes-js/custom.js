...
$(document).ready(function() {
    ...
    $(window).on("load", function() {
        ...
        if (colorcode != "") {
            ...
            if (cssname != '') {
                var new_style = 'https://kamleshyadav.com/html/splashdash/splashdash-admin-template/assets/css/' + cssname + '.css';
    ...
    $('.colorchange').on("click", function() {
        ...
        var new_style = 'https://kamleshyadav.com/html/splashdash/splashdash-admin-template/assets/css/' + name + '.css';
        $('#theme-change').attr('href', new_style);
    });
