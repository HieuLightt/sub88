...
<div class="card mb-4">
<div class="card-body">
<div class="ribbon-title ribbon-primary">Tạo website riêng</div>
<div class="mt-4">
<div class="row">
...
<button type="button" class="btn btn-primary" id="changeToken"><i class="fa fa-exchange"></i> Thay đổi</button>
</form>
</div>
</div>
...
<p><span class="fw-bold">- Bước 4 :</span> <span>Sau khi đã trỏ Nameserver bạn hãy liên hệ zalo: <b class="text-white"><a href="https://zalo.me/0862667899" target="_blank" rel="noopener noreferrer" class="text-light">https://zalo.me/0862667899</a></b> để hỗ trợ kích hoạt.</span></p>
